...
import { 
  Lock, Mail, User, ArrowRight, Loader2, AlertCircle, Eye, EyeOff, 
...
// Certifique-se de que o caminho do AuroraBackground está correto para o seu projeto
...
export default function Login() {
  ...
  // Usando a nossa lógica local do useAuth
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Bem-vindo de volta!", { 
        description: `Sessão iniciada como ${roleToSet.toUpperCase()}` 
      });
  ...
  return (
    <div className="relative flex items-center justify-center w-full min-h-screen p-4 overflow-hidden bg-[#FAF9FB]">
      ...
      <AuroraBackground>
        ...
        <div className="relative z-10 flex flex-row items-center justify-center w-full h-full max-w-[900px] gap-8 lg:gap-16 mx-auto">
                  ...
                  <div className="p-4 mt-2">
                    <div className="bg-white/80 backdrop-blur-xl border border-white shadow-[0_4px_20px_rgba(0,0,0,0.05)] rounded-[2rem] p-4">
                      ...
                      <div className="grid grid-cols-2 grid-rows-2 gap-1 rounded-xl overflow-hidden h-40 border border-slate-100">
                        <img src="https://images.unsplash.com/photo-1516483638261-f4dbaf036963?w=300&fit=crop" className="w-full h-full object-cover" alt="Mosaico 1" />
                        <img src="https://images.unsplash.com/photo-1523906834658-6e24ef2386f9?w=300&fit=crop" className="w-full h-full object-cover" alt="Mosaico 2" />
                        <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=300&fit=crop" className="w-full h-full object-cover" alt="Mosaico 3" />
                        <img src="https://images.unsplash.com/photo-1470252649378-9c29740c9fa8?w=300&fit=crop" className="w-full h-full object-cover" alt="Mosaico 4" />
                      </div>
              ...
              <div className="px-8 pb-8 relative z-10">
                <form onSubmit={handleLogin} className="space-y-5">
                  ...
                  <div className="space-y-2">
                    <label className="ml-1 text-xs font-bold text-slate-600 uppercase tracking-wider">E-mail</label>
                    <div className="relative">
                       <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400" />
                      <input
                        type="email" placeholder="Seu e-mail (ex: aluno@escola.pt)" value={email} onChange={(e) => setEmail(e.target.value)} disabled={isLoading} required
                  ...
                  <Button type="submit" disabled={isLoading || !email || !password} className="w-full h-12 mt-2 font-bold text-white transition-all duration-300 shadow-lg bg-amber-500 hover:bg-amber-600 rounded-xl shadow-amber-500/30 disabled:opacity-50 disabled:cursor-not-allowed group border-0">
