...
export const AuroraBackground = () => (
  <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
    ...
    <div className="absolute top-1/3 -right-32 w-[36rem] h-[36rem] rounded-full opacity-50 aurora-blob"
         style={{ background: "radial-gradient(circle, hsl(var(--sun) / 0.20), transparent 65%)", animationDelay: "-6s" }} />
    <div className="absolute -bottom-40 left-1/4 w-[40rem] h-[40rem] rounded-full opacity-35 aurora-blob"
         style={{ background: "radial-gradient(circle, hsl(var(--primary-glow) / 0.15), transparent 65%)", animationDelay: "-12s" }} />
  </div>
);
